...
const merchItems: MerchItem[] = [
  {
    id: "merch1",
    name: "BangoBongo Logo T-Shirt",
    price: 29.99,
    image: "/placeholder.svg?height=500&width=500",
    cryptoPrice: 0.015,
    description: "Classic black t-shirt featuring the iconic BangoBongo logo on the front and tour dates on the back.",
    category: "clothing",
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: ["Black", "White", "Navy"],
    inStock: true,
    isFeatured: true,
    tags: ["clothing", "t-shirt", "logo"],
    images: [
  ...
  },
  {
    ...
    cryptoPrice: 0.03,
    description:
      "Premium hoodie featuring the Neon Nights tour artwork. Made from high-quality fabric for maximum comfort.",
    category: "clothing",
    sizes: ["S", "M", "L", "XL"],
    colors: ["Black", "Gray"],
    inStock: true,
    relatedTour: "Neon Nights World Tour",
    tags: ["clothing", "hoodie", "tour"],
    images: ["/placeholder.svg?height=500&width=500", "/placeholder.svg?height=500&width=500"],
  },
  {
    id: "merch3",
    name: "Digital Dreams Vinyl LP",
    price: 34.99,
    image: "/placeholder.svg?height=500&width=500",
    cryptoPrice: 0.018,
    description:
      "Limited edition 180g vinyl pressing of the Digital Dreams album, featuring exclusive artwork and a gatefold sleeve.",
    category: "vinyl",
    inStock: true,
    relatedAlbum: "Digital Dreams",
    isLimited: true,
    tags: ["vinyl", "album", "limited edition"],
    images: ["/placeholder.svg?height=500&width=500", "/placeholder.svg?height=500&width=500"],
  },
  {
    id: "merch4",
    name: "BangoBongo Snapback Cap",
    price: 24.99,
    image: "/placeholder.svg?height=500&width=500",
    cryptoPrice: 0.013,
    description: "Adjustable snapback cap with embroidered BangoBongo logo. One size fits most.",
  ...
  {
    id: "merch5",
    name: "Cosmic Beats Limited Edition Poster",
    price: 19.99,
    image: "/placeholder.svg?height=500&width=500",
    cryptoPrice: 0.01,
    description:
      "Limited edition 18x24 inch poster for the Cosmic Beats album. Printed on high-quality art paper with metallic ink details.",
    category: "poster",
    inStock: true,
    relatedAlbum: "Cosmic Beats",
    isLimited: true,
    tags: ["poster", "wall art", "limited edition"],
    images: ["/placeholder.svg?height=500&width=500"],
  },
  {
    id: "merch6",
    name: "Electric Pulse Album Bundle",
    price: 79.99,
    image: "/placeholder.svg?height=500&width=500",
    cryptoPrice: 0.04,
    description: "Complete Electric Pulse album bundle including vinyl, CD, digital download, and exclusive t-shirt.",
    category: "collection",
    sizes: ["S", "M", "L", "XL"],
    inStock: true,
    relatedAlbum: "Electric Pulse",
    isLimited: true,
    isFeatured: true,
    tags: ["bundle", "collection", "value pack"],
    images: ["/placeholder.svg?height=500&width=500", "/placeholder.svg?height=500&width=500"],
  },
  {
    id: "merch7",
    name: "BangoBongo Logo Phone Case",
    price: 19.99,
    image: "/placeholder.svg?height=500&width=500",
    cryptoPrice: 0.01,
    description: "Durable phone case with the BangoBongo logo. Available for various iPhone and Android models.",
    category: "accessories",
    inStock: true,
    tags: ["accessories", "phone case", "mobile"],
    images: ["/placeholder.svg?height=500&width=500"],
  },
  {
    id: "merch8",
    name: "Synth Chronicles Full Digital Discography",
    price: 49.99,
    image: "/placeholder.svg?height=500&width=500",
    cryptoPrice: 0.025,
    description:
      "Complete digital discography including all albums, EPs, and exclusive remixes in high-quality formats (MP3, FLAC, WAV).",
    category: "digital",
    inStock: true,
    tags: ["digital", "music", "download"],
    images: ["/placeholder.svg?height=500&width=500"],
  },
  {
    id: "merch9",
    name: "Tour VIP Package",
    price: 149.99,
    image: "/placeholder.svg?height=500&width=500",
    cryptoPrice: 0.075,
    description: "Exclusive VIP package including tour t-shirt, signed poster, VIP lanyard, and early venue access.",
    category: "tour",
    sizes: ["S", "M", "L", "XL"],
    inStock: true,
    relatedTour: "Neon Nights World Tour",
    isFeatured: true,
    tags: ["tour", "vip", "experience"],
    images: ["/placeholder.svg?height=500&width=500"],
  },
  {
    id: "merch10",
    name: "BangoBongo LED Light Sign",
    price: 89.99,
    image: "/placeholder.svg?height=500&width=500",
    cryptoPrice: 0.045,
    description:
      "Customizable LED light sign with the BangoBongo logo. Features multiple color modes and remote control.",
    category: "accessories",
    inStock: true,
    isLimited: true,
    tags: ["accessories", "lighting", "decor"],
    images: ["/placeholder.svg?height=500&width=500", "/placeholder.svg?height=500&width=500"],
  },
  {
    id: "merch11",
    name: "Digital Dreams Album T-Shirt",
    price: 29.99,
    image: "/placeholder.svg?height=500&width=500",
    cryptoPrice: 0.015,
    description: "T-shirt featuring artwork from the Digital Dreams album. Made from 100% organic cotton.",
    category: "clothing",
    sizes: ["S", "M", "L", "XL"],
    colors: ["Black", "Blue"],
    inStock: true,
    relatedAlbum: "Digital Dreams",
    tags: ["clothing", "t-shirt", "album"],
    images: ["/placeholder.svg?height=500&width=500"],
  },
  {
    id: "merch12",
    name: "BangoBongo Beanie",
    price: 21.99,
    image: "/placeholder.svg?height=500&width=500",
    cryptoPrice: 0.011,
    description: "Warm and comfortable beanie with embroidered BangoBongo logo. Perfect for cooler weather.",
    category: "clothing",
    colors: ["Black", "Gray", "Navy"],
    inStock: true,
    tags: ["clothing", "hat", "winter"],
    images: ["/placeholder.svg?height=500&width=500"],
  },
  {
    id: "merch13",
    name: "Hyperspace Journey Collector's Vinyl Box Set",
    price: 99.99,
    image: "/placeholder.svg?height=500&width=500",
    cryptoPrice: 0.05,
    description:
      "Deluxe collector's box set of Hyperspace Journey on colored vinyl with bonus tracks, art booklet, and exclusive poster.",
    category: "vinyl",
    inStock: true,
    relatedAlbum: "Hyperspace Journey",
    isLimited: true,
    isFeatured: true,
    tags: ["vinyl", "collector's edition", "box set"],
    images: [
      "/placeholder.svg?height=500&width=500",
      "/placeholder.svg?height=500&width=500",
      "/placeholder.svg?height=500&width=500",
  ...
  {
    id: "merch14",
    name: "Summer Festival Bandana",
    price: 14.99,
    image: "/placeholder.svg?height=500&width=500",
    cryptoPrice: 0.0075,
    description: "Colorful bandana featuring festival-inspired artwork. Perfect for summer events and festivals.",
    category: "accessories",
    inStock: true,
    tags: ["accessories", "bandana", "festival"],
    images: ["/placeholder.svg?height=500&width=500"],
  },
  {
    id: "merch15",
    name: "BangoBongo Water Bottle",
    price: 24.99,
    image: "/placeholder.svg?height=500&width=500",
    cryptoPrice: 0.0125,
    description:
      "Eco-friendly stainless steel water bottle with the BangoBongo logo. Keeps drinks cold for 24 hours or hot for 12 hours.",
    category: "accessories",
    colors: ["Silver", "Black", "Teal"],
    inStock: true,
    tags: ["accessories", "water bottle", "eco-friendly"],
    discountPercentage: 15,
    images: ["/placeholder.svg?height=500&width=500"],
  },
  {
    id: "merch16",
    name: "Artist Collaboration Tote Bag",
    price: 19.99,
    image: "/placeholder.svg?height=500&width=500",
    cryptoPrice: 0.01,
    description:
      "Limited edition tote bag featuring artwork from a collaboration with renowned visual artist Maya Lin.",
    category: "accessories",
    inStock: true,
    isLimited: true,
    tags: ["accessories", "bag", "collaboration"],
    images: ["/placeholder.svg?height=500&width=500"],
  },
]
