...
export default function EditProductPage() {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          limitedEdition: data.product.limitedEdition,
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setErrors({ delete: 'Failed to delete product. Please try again.' })
    } finally {
      setDeleting(false)
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Modify product details and settings</p>
          </div>
        </div>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="text-center">
                ...
                <p className="text-2xl font-bold">${(product.sold * product.price).toFixed(2)}</p>
              </div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-4">
              <div className="text-center">
                ...
                <p className="text-2xl font-bold">{product.trackInventory ? product.stock : '∞'}</p>
              </div>
            </CardContent>
          </Card>
        </div>
          ...
          <TabsContent value="media" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage product images. First image will be the main product image.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
