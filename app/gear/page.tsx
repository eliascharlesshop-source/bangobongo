...
export const metadata: Metadata = {
  title: "Gear | BangoBongo",
  description: "Explore the equipment and setup used by BangoBongo for producing and performing electronic music.",
}
...
export default function GearPage() {
  ...
  const gearByCategory: Record<string, GearItem[]> = gearItems.reduce(
    (acc, item) => {
